...
void MV_MixFPMono8(uint32_t position, uint32_t rate, const uint8_t* start, uint32_t length);

void MV_MixFPMono16(uint32_t position, uint32_t rate, const uint8_t* start, uint32_t length);

void MV_MixFPStereo8(uint32_t position, uint32_t rate, const uint8_t* start, uint32_t length);
