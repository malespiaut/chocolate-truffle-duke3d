...
char*
DSL_ErrorString(int ErrorNumber)
{
  char* ErrorString;
...
static void
DSL_SetErrorCode(int ErrorCode)
{
...
static void
mixer_callback(int chan, void* stream, int len, void* udata)
{
  Uint8* stptr;
  Uint8* fxptr;
  int copysize;
...
int
DSL_BeginBufferedPlayback(char* BufferStart,
                          int BufferSize,
                          int NumDivisions,
                          unsigned SampleRate,
                          int MixMode,
