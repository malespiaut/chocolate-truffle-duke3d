...
void
CVARDEFS_DefaultFunction(void* var)
{
  int argc;
...
void
CVARDEFS_FunctionQuit(void* var)
{
  if (numplayers > 1)
  {
...
// This function will quit the game
void
CVARDEFS_FunctionClear(void* var)
{
  CONSOLE_Reset();
}
...
// The player
void
CVARDEFS_FunctionName(void* var)
{
  int argc, length, i;
...
void
CVARDEFS_FunctionLevel(void* var)
{
  int argc;
  ...
  if (argc == 2)
  {
    ...
    if (numplayers > 1 && myconnectindex == connecthead)
    {
      ...
      ps[myconnectindex].gm |= MODE_RESTART; // Otherwise just restart the game
  }
  else
  {
...
void
CVARDEFS_FunctionPlayMidi(void* var)
{
...
void
CVARDEFS_FunctionHelp(void* var)
{
