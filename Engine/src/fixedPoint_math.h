...
static inline void
swapchar(uint8_t* p1, uint8_t* p2)
{
  uint8_t tmp = *p1;
  *p1 = *p2;
  *p2 = tmp;
...
static inline void
swaplong(int32_t* p1, int32_t* p2)
{
  int32_t tmp = *p1;
  *p1 = *p2;
  *p2 = tmp;
...
static inline void
swapchar2(uint8_t* p1, uint8_t* p2, int xsiz)
{
  swapchar(p1, p2);
...
mul32_64(int32_t i1, int32_t i2)
{
  return (int64_t)i1 * i2;
}
static inline int
scale(int32_t input1, int32_t input2, int32_t input3)
{
  return (int)(mul32_64(input1, input2) / (int64_t)input3);
}
static inline int
scaleup(int32_t input1, int32_t input2, int32_t input3)
{
...
static inline int
mulscale(int32_t input1, int32_t input2, int32_t input3)
{
  return (int)(mul32_64(input1, input2) >> input3);
}
static inline int
dmulscale(int32_t input1, int32_t input2, int32_t input3, int32_t input4, int32_t input5)
{
  return (int)((mul32_64(input1, input2) + mul32_64(input3, input4)) >> input5);
}
static inline int
tmulscale(int32_t i1, int32_t i2, int32_t i3, int32_t i4, int32_t i5, int32_t i6, int32_t shift)
{
  return (int)((mul32_64(i1, i2) + mul32_64(i3, i4) + mul32_64(i5, i6)) >> shift);
}
static inline int32_t
divscale(int32_t i1, int32_t i2, int32_t i3)
{
