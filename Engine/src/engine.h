...
extern "C"
{
  ...
  int hitscan(int32_t xs, int32_t ys, int32_t zs, int16_t sectnum, int32_t vx, int32_t vy, int32_t vz, int16_t* hitsect, int16_t* hitwall, int16_t* hitsprite, int32_t* hitx, int32_t* hity, int32_t* hitz, uint32_t cliptype);
  ...
  int rintersect(int32_t x1, int32_t y1, int32_t z1, int32_t vx, int32_t vy, int32_t vz, int32_t x3, int32_t y3, int32_t x4, int32_t y4, int32_t* intx, int32_t* inty, int32_t* intz);
  ...
  int nextsectorneighborz(int16_t sectnum, int32_t thez, int16_t topbottom, int16_t direction);
  int neartag(int32_t xs, int32_t ys, int32_t zs, int16_t sectnum, int16_t ange, int16_t* neartagsector, int16_t* neartagwall, int16_t* neartagsprite, int32_t* neartaghitdist, int32_t neartagrange, uint8_t tagsearch);
  int pushmove(int32_t* x, int32_t* y, int32_t* z, int16_t* sectnum, int32_t walldist, int32_t ceildist, int32_t flordist, uint32_t cliptype);
  ...
  void makepalookup(int32_t palnum, uint8_t* remapbuf, int8_t r, int8_t g, int8_t b, uint8_t dastat);
  ...
  void preparemirror(int32_t dax, int32_t day, int32_t daz, int16_t daang, int32_t dahoriz, int16_t dawall, int16_t dasector, int32_t* tposx, int32_t* tposy, short* tang);
