...
void
sethlinesizes(int32_t i1, int32_t _bits, const uint8_t* textureAddress)
{
  machxbits_al = i1;
  bitsSetup = _bits;
...
void
hlineasm4(int32_t numPixels, int32_t shade, uint32_t i4, uint32_t i5, uint8_t* dest)
{
...
void
setuprhlineasm4(int32_t i1, int32_t i2, int32_t i3, const uint8_t* i4, int32_t i5, int32_t i6)
{
  rmach_eax = i1;
  rmach_ebx = i2;
  rmach_ecx = i3;
...
void
rhlineasm4(int32_t i1, const uint8_t* texture, int32_t i3, uint32_t i4, uint32_t i5, uint8_t* dest)
{
  uint32_t ebp = 0;
  int32_t numPixels;
  int32_t offset = i1 + 1;
...
void
setuprmhlineasm4(int32_t i1, int32_t i2, int32_t i3, const uint8_t* i4, int32_t tileHeight, int32_t i6)
{
  rmmach_eax = i1;
  rmmach_ebx = i2;
  rmmach_ecx = i3;
...
// FCS: ????
void
rmhlineasm4(int32_t i1, const uint8_t* shade, int32_t colorIndex, int32_t i4, int32_t i5, uint8_t* dest)
{
  uint32_t ebp = 0;
  int32_t numPixels;
  int32_t offset = i1 + 1;
...
void
setBytesPerLine(int32_t _bytesperline)
{
...
int32_t
prevlineasm1(int32_t i1, const uint8_t* palette, int32_t i3, int32_t i4, const uint8_t* source, uint8_t* dest)
{
  if (i3 == 0)
  {
...
int32_t
vlineasm1(int32_t vince, const uint8_t* palookupoffse, int32_t numPixels, int32_t vplce, const uint8_t* texture, uint8_t* dest)
{
  uint32_t temp;
...
int32_t
tvlineasm1(int32_t i1, const uint8_t* texture, int32_t numPixels, int32_t i4, const uint8_t* source, uint8_t* dest)
{
...
void
setuptvlineasm2(int32_t i1, const uint8_t* i2, const uint8_t* i3)
{
  tran2shr = (i1 & 0x1f);
  tran2pal_ebx = i2;
  tran2pal_ecx = i3;
...
void
tvlineasm2(uint32_t i1, uint32_t i2, uintptr_t i3, uintptr_t i4, uint32_t i5, uintptr_t i6)
{
  uint32_t ebp = i1;
...
int32_t
mvlineasm1(int32_t vince, const uint8_t* palookupoffse, int32_t i3, int32_t vplce, const uint8_t* texture, uint8_t* dest)
{
  uint32_t temp;
...
void
vlineasm4(int32_t columnIndex, uint8_t* framebuffer)
{
...
void
mvlineasm4(int32_t columnIndex, uint8_t* framebuffer)
{
  int i;
  uint32_t temp;
  uint32_t index = 0;
...
uint32_t tsmach_ecx;
void
tsetupspritevline(const uint8_t* palette, int32_t i2, int32_t i3, int32_t i4, int32_t i5)
{
  tspal = palette;
  tsmach_eax1 = i5 << 16;
  adder = (i5 >> 16) + i2;
 ...
 */
void
DrawSpriteVerticalLine(int32_t i2, int32_t numPixels, uint32_t i4, const uint8_t* texture, uint8_t* dest)
{
  uint8_t colorIndex;
...
void
mhline(uint8_t* texture, int32_t i2, int32_t numPixels, int32_t i4, int32_t i5, uint8_t* dest)
{
  textureData = texture;
  mmach_asm3 = asm3;
  mmach_asm1 = asm1;
...
void
mhlineskipmodify(uint32_t i2, int32_t numPixels, int32_t i5, uint8_t* dest)
{
  uint32_t ebx;
  int32_t colorIndex;
...
void
msethlineshift(int32_t i1, int32_t i2)
{
  i1 = 256 - i1;
  mshift_al = (i1 & 0x1f);
  mshift_bl = (i2 & 0x1f);
...
void
thline(uint8_t* i1, int32_t i2, int32_t i3, int32_t i4, int32_t i5, uint8_t* i6)
{
  tmach_eax = i1;
  tmach_asm3 = asm3;
  tmach_asm1 = asm1;
...
void
thlineskipmodify(int32_t i1, uint32_t i2, uint32_t i3, int32_t i4, int32_t i5, uint8_t* i6)
{
  uint32_t ebx;
  int counter = (i3 >> 16);
  while (counter >= 0)
...
void
tsethlineshift(int32_t i1, int32_t i2)
{
  i1 = 256 - i1;
  tshift_al = (i1 & 0x1f);
  tshift_bl = (i2 & 0x1f);
...
void
setupslopevlin(int32_t i1, intptr_t i2, int32_t i3)
{
  bitwisef2i c;
  slopemach_ebx = i2;
  slopemach_ecx = i3;
...
void
slopevlin(intptr_t i1, uint32_t i2, intptr_t* i3, uint32_t index, int32_t i4, int32_t i5, int32_t i6)
{
  bitwisef2i c;
