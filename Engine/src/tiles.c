...
void
setviewtotile(short tilenume, int32_t tileWidth, int32_t tileHeight)
{
  int32_t i, j;
...
uint8_t*
allocatepermanenttile(short tilenume, int32_t width, int32_t height)
{
  int32_t j;
...
int
loadpics(char* filename, char* gamedir)
...
void
TILE_MakeAvailable(short picID)
{
...
void
copytilepiece(int32_t tilenume1, int32_t sx1, int32_t sy1, int32_t xsiz, int32_t ysiz, int32_t tilenume2, int32_t sx2, int32_t sy2)
{
